...
namespace Asteroid_Belt_Assault
{
    class AsteriodManager
    {
        ...
        public AsteriodManager(int asteroidCount, Texture2D texture, Rectangle initialFrame, int asteroidFrames, int screenWidth, int screenHeight)
        {
        ...
        private void BounceAsteroids(Sprite asteroid1, Sprite asteroid2)        // calculates the velocity of the center of mass of each asteroid and makes a collision effect
        {
            {
