...
namespace Asteroid_Belt_Assault
{
    class EnemyManager
    {
        ...
        public int numOfShipWaves = 0;

        //private float ChanceDiv = 10;

        private float increaseShipShotRate;
        ...
        public void Update(GameTime gameTime)
        {
            ...
            increaseShipShotRate += (float)gameTime.ElapsedGameTime.TotalSeconds;

            if (increaseShipShotRate >= 20.0f)
            {
                shipShotChance += 0.1f;
                increaseShipShotRate = 0.0f;
            }
            if (Active)
            {
        ...
        private void updateWaveSpawns(GameTime gameTime)
        {
            ...
            if (shipSpawnTimer >= 30.0f)
            {
                shipSpawnWaitTime -= .01f;
            }
