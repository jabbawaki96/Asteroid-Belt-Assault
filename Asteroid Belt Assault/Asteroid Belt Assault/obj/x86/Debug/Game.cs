...
namespace Asteroid_Belt_Assault
{
    ...
    public class Game : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            asteroidManager = new AsteriodManager(10, spriteSheet, new Rectangle(0, 0, 50, 50), 20, this.Window.ClientBounds.Width, this.Window.ClientBounds.Height);   // Player
            playerManager = new PlayerManager(spriteSheet, new Rectangle(0, 150, 50, 50), 3, new Rectangle(0, 0, this.Window.ClientBounds.Width,
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            {
                spriteBatch.DrawString(pericles14, "Press Y to RESPAWN", new Vector2(this.Window.ClientBounds.Width / 2 - pericles14.MeasureString("G A M E  O V E R !").X / 2, 50), Color.White);
            }
            //
